...
<div class="card">
	...
	<div class="card-body card-block">
		<!-- enctype untuk menambahkan gambar -->
		<form action="{{ route('products-galleries.store') }}" method="post" enctype="multipart/form-data"> 
			...
			<div class="form-group">
				...
				<!-- accept = value yang di perbolehkan -->
			...
			<div class="form-group">
				...
				<br>
					...
					&nbsp;
					<label>
						<input type="radio" name="is_default" value="0" class="form-control @error('is_default') is-invalid @enderror" style="max-width: 17px;" />tidak
					</label>
